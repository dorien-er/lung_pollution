...
image_filename = '../lung_pollution/lung_pollution/data/images/intro.png'
encoded_image = base64.b64encode(open(image_filename, 'rb').read())

image_filename_2 = '../lung_pollution/lung_pollution/data/images/under-the-hood.png'
encoded_image_2 = base64.b64encode(open(image_filename_2, 'rb').read())

image_filename_3 = '../lung_pollution/lung_pollution/data/images/kde.png'
